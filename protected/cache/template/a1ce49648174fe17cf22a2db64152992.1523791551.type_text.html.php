<?php if(!class_exists("View", false)) exit("no direct access allowed");?><tr id="type-text" class="type-tr hide">
  <th>文字广告</th>
  <td>
    <div class="pad5">
      <label><font class="c666 mr5">文字内容:</font><input id="text-content" class="w400 txt" name="text_params[content]" type="text" /></label>
    ...
    <div class="pad5">
      ...
      <span class="mr5"><input title="下划线" type="text" data-style="u:0" class="fwdt widget-face underline" id="text-underline-widget" readonly="readonly" value="U" /></span>
    ...
    <div class="mt5 pad5">
      <label><font class="c666 mr5">文字链接:</font><input title="文字链接" id="text-link" class="w400 txt" name="text_params[link]" type="text" /></label>
